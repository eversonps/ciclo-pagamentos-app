...
class ItemList extends Component{
    ...
    renderRows(){
        ...
        return list.map((item, index) => (
            <tr key={index}>
                <td><Field name={`${this.props.fields}[${index}].name`} component={Input} placeholder="Informe o nome" readOnly={this.props.readOnly}/></td>
                <td><Field name={`${this.props.fields}credits[${index}].value`} component={Input} placeholder="Informe o valor" readOnly={this.props.readOnly}/></td>
                <td>
